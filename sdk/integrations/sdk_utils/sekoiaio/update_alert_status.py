...
ACTION_ACK = StatusWorkflowAction("937bdabf-6a08-434b-b6d3-d7447e4e452a", "Acknowledge", "Acknowledge the alert")
ACTION_VALIDATE = StatusWorkflowAction("c39a0a95-aa2c-4d0d-8d2e-d3decf426eea", "Validate", "Validate the alert")
ACTION_REJECT = StatusWorkflowAction("ade85d7b-7507-4026-bfc6-cc006d10ddac", "Reject", "Reject the alert")
ACTION_CLOSE = StatusWorkflowAction("1390be4e-ced8-4dd6-9bed-573471b235ab", "Close", "Close the alert")
